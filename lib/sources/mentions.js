...
${MentionsSource.formatTweet(tweet)}`, false, null, this._config, tweetPermalink);

            const card = await this._repo.createCard(`Mention by ${tweet.user.screen_name}`, issueText.toString(), reactionColumn, "top").catch(console.error);
