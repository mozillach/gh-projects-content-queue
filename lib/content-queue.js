...
class ContentQueue {
    ...
    constructor(accountManager, config) {
        ...
        this.makeAccountList().then((accountsList) => {
            /**
            * @type {module:repo.Repository}
            */
            this.repo = new Repository(githubClient, config, accountsList);
    ...
    async makeAccountList() {
        //TODO only list accounts used by this board. Also, what if there are multiple boards in a repo?
        const accounts = this.accountManager.getContentAccounts();
