...
class Repository {
    ...
    addIssueTemplate() {
        ...
        //TODO use formatters, should somehow know which formatters to get sections from.
        const issueTemplate = Formatter.GetTemplateSections[Formatter.META];
        return this.addFile("ISSUE_TEMPLATE.md", issueTemplate, "Issue template for content queue");
    }
